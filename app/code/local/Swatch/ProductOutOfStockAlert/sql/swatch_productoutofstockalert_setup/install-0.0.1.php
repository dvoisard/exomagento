...
try {
    $table = $installer->getConnection()
        ->newTable($installer->getTable('swatch_productoutofstockalert/alert'))
        ...
        ->addIndex(
            $installer->getIdxName(
                $installer->getTable('swatch_productoutofstockalert/alert'),
                array('entered_at'),
        ...
        ->addForeignKey(
            $installer->getFkName('swatch_productoutofstockalert/alert', 'product_id', 'catalog/product', 'entity_id'),
            'product_id',
